...
@Injectable()
export class ShowOnDataTableClusterSummaryWeekBaseService {
    constructor(
    ...
    public getSpatialDataWeekBase(week, interval): Observable<any> {
        let apiUrl = './assets/data/spatial/' + week + '/' + interval + '.json';
        return this.http.get(apiUrl)
            .pipe(catchError(
                e => throwError(e)
            )
