...
import { ShowOnMap5MinService } from './show-on-map-5min.service';
...
@Component({
	selector: 'showonmap5min',
	templateUrl: './show-on-map-5min.component.html',
	styleUrls: ['show-on-map-5min.component.scss'],
})
export class ShowOnMap5MinComponent implements OnInit {
	...
	*/
	...
	constructor(private renderer: Renderer2, private elementRef: ElementRef, private _service: ShowOnMap5MinService) {
	}
