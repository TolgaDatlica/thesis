...
import { ShowOnMap3MinService } from './show-on-map-3min.service';
...
@Component({
	selector: 'showonmap3min',
	templateUrl: './show-on-map-3min.component.html',
	styleUrls: ['show-on-map-3min.component.scss'],
})
export class ShowOnMap3MinComponent implements OnInit {
	...
	*/
	...
	constructor(private renderer: Renderer2, private elementRef: ElementRef, private _service: ShowOnMap3MinService) {
	}
